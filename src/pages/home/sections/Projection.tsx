          ...
          <div className="overflow-hidden bg-white border border-gray-200 rounded-lg">
            <div className="px-4 py-6">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h4 className="text-4xl font-bold text-gray-900">200+</h4>
                  <p className="mt-1.5 text-lg font-medium leading-tight text-gray-500">
                    Satisfied Buyer
                  </p>
                </div>
          ...
          <div className="overflow-hidden bg-white border border-gray-200 rounded-lg">
            <div className="px-4 py-6">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h4 className="text-4xl font-bold text-gray-900">1,274</h4>
                  <p className="mt-1.5 text-lg font-medium leading-tight text-gray-500">
                    Product delivered
                  </p>
                </div>
          ...
          <div className="overflow-hidden bg-white border border-gray-200 rounded-lg">
            <div className="px-4 py-6">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h4 className="text-4xl font-bold text-gray-900">97%</h4>
                  <p className="mt-1.5 text-lg font-medium leading-tight text-gray-500">
                    Customer success
                  </p>
                </div>
